...
/**
         ...
         * @preserve
         */
constructor(e,t){q._instanceID?q._instanceID+=1:q._instanceID=0,this._dataLayer=new $(`instance_${q._instanceID}`,e),this._authenticationCore=new J(this._dataLayer,t),q._authenticationCore=new J(this._dataLayer,t)}
/**
         *
         ...
         *
         * @preserve
         */initialize(e){var i,o,n;return t(this,void 0,void 0,(function*(){yield this._dataLayer.setConfigData(Object.assign(Object.assign(Object.assign({},M),e),{scope:[...null!==(i=M.scope)&&void 0!==i?i:[],...null!==(n=null===(o=e.scope)||void 0===o?void 0:o.filter((e=>{var t;return!(null===(t=null==M?void 0:M.scope)||void 0===t?void 0:t.includes(e))})))&&void 0!==n?n:[]]}))}))}
/**
...
/**
         ...
         *
         * @preserve
         */static isSignOutSuccessful(e){const t=new URL(e),i=t.searchParams.get(L),o=Boolean(t.searchParams.get("error"));return!!i&&(i===A&&!o)}
/**
         ...
         *
         * @preserve
         */static didSignOutFail(e){const t=new URL(e),i=t.searchParams.get(L),o=Boolean(t.searchParams.get("error"));return!!i&&(i===A&&o)}
/**
         ...
         *
         * @preserve
         */updateConfig(e){return t(this,void 0,void 0,(function*(){yield this._authenticationCore.updateConfig(e)}))}static clearUserSessionData(e){return t(this,void 0,void 0,(function*(){yield this._authenticationCore.clearUserSessionData(e)}))}}e.AUTHORIZATION_CODE="code",e.AsgardeoAuthClient=q,e.AsgardeoAuthException=b,e.AuthenticationUtils=K,e.CLAIM_VALIDATION_ERROR=E,e.CLIENT_ID_TAG=S,e.CLIENT_SECRET_TAG=C,e.CryptoHelper=j,e.DataLayer=$,e.NBF_CLAIM="nbf",e.OIDC_SCOPE=U,e.PKCE_CODE_VERIFIER=O,e.PKCE_SEPARATOR=P,e.REFRESH_TOKEN_TIMER="refresh_token_timer",e.SCOPE_TAG=k,e.SESSION_STATE=w,e.SIGN_OUT_SUCCESS_PARAM=A,e.SIGN_OUT_URL="sign_out_url",e.STATE=L,e.SUPPORTED_SIGNATURE_ALGORITHMS=R,e.TOKEN_TAG=m,e.USERNAME_TAG=T,Object.defineProperty(e,"__esModule",{value:!0})}));
